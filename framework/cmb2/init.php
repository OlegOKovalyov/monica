...
if ( ! class_exists( 'CMB2_Bootstrap_212', false ) ) {
	...
	class CMB2_Bootstrap_212 {
		...
		public function include_cmb() {
			...
			if ( ! defined( 'CMB2_DIR' ) ) {
				define( 'CMB2_DIR', trailingslashit( get_template_directory().'/framework/cmb2/' ) );
			}

			$this->l10ni18n();

			// Include helper functions
			require_once get_template_directory().'/framework/cmb2/includes/helper-functions.php';
		...
		public function l10ni18n() {
			...
			if ( ! $loaded ) {
				...
				$mofile = get_template_directory() . '/framework/cmb2/languages/cmb2-' . $locale . '.mo';

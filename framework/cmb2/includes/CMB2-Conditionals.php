...
add_action('after_setup_theme', 'cmb2_conditionals_load_actions');
...
function cmb2_conditionals_footer()
{
	...
	wp_enqueue_script('cmb2-conditionals', get_template_directory_uri().'/framework/cmb2/js/cmb2-conditionals.js', array('jquery'), '1.0.2', true);
}

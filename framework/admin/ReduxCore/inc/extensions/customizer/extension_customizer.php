        ...
        class ReduxFramework_extension_customizer {
            ...
            public function __construct( $parent ) {
                ...
                if ( empty( $this->_extension_dir ) ) {
                    $this->_extension_dir = Redux_Helpers::get_extension_dir( get_template_directory().'/framework/admin/ReduxCore/inc/extensions/customizer/' );
                    $this->_extension_url = Redux_Helpers::get_extension_url( get_template_directory().'/framework/admin/ReduxCore/inc/extensions/customizer/' );
                }
            ...
            public function _register_customizer_controls( $wp_customize ) {
                ...
                if ( ! class_exists( 'Redux_Customizer_Section' ) ) {
                    require_once get_template_directory() . '/framework/admin/ReduxCore/inc/extensions/customizer/inc/customizer_section.php';
                    if ( method_exists( $wp_customize, 'register_section_type' ) ) {
                        $wp_customize->register_section_type( 'Redux_Customizer_Section' );
                    }
                }
                if ( ! class_exists( 'Redux_Customizer_Panel' ) ) {
                    require_once get_template_directory() . '/framework/admin/ReduxCore/inc/extensions/customizer/inc/customizer_panel.php';
                ...
                if ( ! class_exists( 'Redux_Customizer_Control' ) ) {
                    require_once get_template_directory() . '/framework/admin/ReduxCore/inc/extensions/customizer/inc/customizer_control.php';
                }

                require_once get_template_directory() . '/framework/admin/ReduxCore/inc/extensions/customizer/inc/customizer_fields.php';
                require_once get_template_directory() . '/framework/admin/ReduxCore/inc/extensions/customizer/inc/customizer_devs.php';

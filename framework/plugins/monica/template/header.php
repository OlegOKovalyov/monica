                    ...
                    <div class="extra-menu">
                        <div class="header-search-form hidden-xs hidden-sm">
                            <form method="get" action="<?php echo esc_url(home_url( '/' )); ?>">
                                <input type="search" class="search-field" placeholder="<?php echo esc_attr( 'Type to search ...', 'monica_theme' ) ?>" value="<?php echo get_search_query() ?>" name="s" title="<?php echo esc_attr( 'Search for:', 'monica_theme' ) ?>" />
                            </form>
                        </div>
                        <nav>
                            <ul>

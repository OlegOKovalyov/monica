...
// Exit if accessed directly
    ...
    if ( ! class_exists( 'ReduxFrameworkInstances' ) ) {
        // Instance Container
        require_once get_template_directory() . '/framework/admin/ReduxCore/inc/class.redux_instances.php';
        require_once get_template_directory() . '/framework/admin/ReduxCore/inc/lib.redux_instances.php';
    }
...
// Don't duplicate me!
    if ( ! class_exists( 'ReduxFramework' ) ) {
        ...
        // Redux CDN class
        require_once get_template_directory() . '/framework/admin/ReduxCore/inc/class.redux_cdn.php';

        // Redux API class  :)
        require_once get_template_directory() . '/framework/admin/ReduxCore/inc/class.redux_api.php';

        // General helper functions
        require_once get_template_directory() . '/framework/admin/ReduxCore/inc/class.redux_helpers.php';

        // General functions
        require_once get_template_directory() . '/framework/admin/ReduxCore/inc/class.redux_functions.php';
        require_once get_template_directory() . '/framework/admin/ReduxCore/inc/class.p.php';

        require_once get_template_directory() . '/framework/admin/ReduxCore/inc/class.thirdparty.fixes.php';

        require_once get_template_directory() . '/framework/admin/ReduxCore/inc/class.redux_filesystem.php';

        require_once get_template_directory() . '/framework/admin/ReduxCore/inc/class.redux_admin_notices.php';

        // ThemeCheck checks
        require_once get_template_directory() . '/framework/admin/ReduxCore/inc/themecheck/class.redux_themecheck.php';
        ...
        class ReduxFramework {
            ...
            public static function init() {
                $dir = Redux_Helpers::cleanFilePath( get_template_directory().'/framework/admin/ReduxCore/' );
...
// get_instance()
            ...
            private function _tracking() {
                if ( file_exists( get_template_directory() . '/framework/admin/ReduxCore/inc/tracking.php' ) ) {
                    require_once get_template_directory() . '/framework/admin/ReduxCore/inc/tracking.php';
...
// _register_settings()
            ...
            private function _register_extensions() {
                $path    = get_template_directory() . '/framework/admin/ReduxCore/inc/extensions/';

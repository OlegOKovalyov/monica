 ...
 * @version   2.5.2 for parent theme Monica for publication on ThemeForest
...
function monica_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'                  => 'Monica',
            'slug'                  => 'monica_theme',
            'source'                => get_stylesheet_directory() . '/framework/plugins/monica.zip',
            'required'              => true,
            'version'               => '',
            'force_activation'      => false,
            'force_deactivation'    => false,
    ...
    $theme_text_domain = 'monica_theme';

    tgmpa( $plugins );

}
add_action( 'tgmpa_register', 'monica_register_required_plugins' );
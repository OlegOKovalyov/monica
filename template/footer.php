    ...
    <div class="footer-widgets">
        <div class="container">
            <div class="row">
                ...
                <?php if ( $footer_3_w ) : ?>
                <div class="foot-3 col-sm-6 col-xs-12 col-md-<?php echo esc_attr( $footer_3_w );?> col-lg-<?php echo esc_attr( $footer_3_w );?>">
                ...
                <div class="col-sm-6 col-xs-12 col-md-4 col-lg-4">
                    ...
                    <div class="col-sm-6 col-xs-12 col-md-4 col-lg-4" style="">
                        <div class="footer-credits heading-font">
                            <span class="copyright"><?php echo '© '.date('Y').' ' .esc_attr( monica_option_data( 'editor_footer_copyright' ) );?></span>
                        </div>
                    </div>
            </div>
        </div><!-- // .container -->

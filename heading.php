                  ...
                  <div class="page-tagline">
                        <span>
                            <?php
                                ...
                                elseif ( is_single() ) :
                                    printf( '<span class="subheading">'.esc_html__( '', 'monica_theme' ).'</span>' );
                                elseif ( is_category() ) :
